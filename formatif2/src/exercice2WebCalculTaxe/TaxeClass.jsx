...
class TaxeClass extends React.Component{
    ...
    render(){
        ...
        return (
            <div id="styleDiv">
                <h1 style={{color:"white",margin:"0px"}}>Calcul des taxes</h1>
                <img src={AvionImage} alt="image" style={{position:"absolute",top:"20px",left:"20px"}}/>
            <div id="enfantCal">
                ...
                <br></br>
                    ...
                    <p style={{color:"white",}}>@ Cégep Limoilou - 2023</p>
